...
import {fetchRHOAINotebooksPerfJobsData} from "../../store/Actions/ActionCreator";
import {BenchmarkResults} from "./BenchmarkResults";


export function RhoaiNotebooksPerfHome() {
    ...
    useEffect(() => {
        ...
        history.push(`/rhoai_notebooks_performance?${buildParams.substring(1)}`, { replace: true });
    ...
    useEffect(() => {
        if(startDate || endDate){
            dispatch(fetchRHOAINotebooksPerfJobsData(startDate, endDate))
        }
